        ...
        <form className="form" onSubmit={e=>submitHandler(e)}> 
          <div className="form-group">
            <input
              ...
              name="title"
              value={title} onChange = {e=> changeHandler(e)}
              required
            />
          </div>
          <div className="form-group">
            <input
              ...
              placeholder="* Company"
              name="company"
              value={company} onChange = {e=> changeHandler(e)}
              required
            />
          </div>
          <div className="form-group">
              
            <input type="text" placeholder="Location" value={location} onChange = {e=> changeHandler(e)} name="location" />
          </div>
          <div className="form-group">
            <h4>From Date</h4>
